...
public class ProfileFragment extends RxFragment {
	...
	public void onResume() {
		...
		EasyCreditApi.INSTANCE.getCreditRequests(user.getId(), CreditRequest.PENDING)
			...
			.subscribe((data, error) -> {
				...
				this.binding.caption.setText(this.getString(R.string.pending_credit_requests, data.size()));
